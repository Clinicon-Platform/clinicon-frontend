...
from app.routers import auth, appointments, medical_records, files, medications, telegram, chatbot, visit, patient_notes, doctors, clinic_owner, billing, inventory, expenses, dashboard
