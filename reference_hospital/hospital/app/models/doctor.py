import uuid
from sqlalchemy import Column, String, Text, SmallInteger, Time, Boolean, ForeignKey, CheckConstraint, DateTime, Uuid, Integer, Numeric
...
class Doctor(Base):
    ...
    consultation_price = Column(Numeric, nullable=True)
    bio = Column(Text)
